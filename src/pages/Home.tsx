...
export const Home = () => {
    return (
        <>
            <Col className="items-center w-full lg:mt-32">
                <div className="text-3xl lg:text-5xl text-center">
                    <h1>
                        Composez <HighlightText>votre</HighlightText> carte des régions
                    </h1>
                </div>
                <div className="text-2xl lg:text-3xl mt-8 lg:mt-32 pt-8 w-full bg-surface">
                    <p className="text-center">
                        Selectionnez un point de depart
                    </p>
                    <div className="justify-evenly mb-6 py-8 flex flex-col lg:flex-row items-center">
...
const TemplateTile = ({name, data, image}: TemplateTileProps) => {
    return (
        <Link to={`/carte/${data}`} className="bg-background rounded-xl m-2 lg:w-1/4 overflow-clip">
            <Col>
                <div>
